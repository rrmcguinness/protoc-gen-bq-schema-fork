...
def go_dependencies():
    ...
    go_repository(
        ...
        sum = "h1:i1WhCk90cAd63wnz5dAoQSQtBeEV3IUUXtbyFzkk6l4=",
        version = "v0.0.0-20220919222850-4c4a9a261e29",
    )
    ...
    go_repository(
        ...
        sum = "h1:n6s1iQaZhG/vSQE89eiGddcB257xN4KZbXhRYg9f80o=",
        version = "v1.41.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:ou3VRVAif8UJqz3l1r4Isoz7rrUWHWDHBonShMNYoQs=",
        version = "v0.0.0-20220913154956-18f8339a66a5",
    )
    go_repository(
